...
#It might just be adding all of the columns
#We should be generating a column that is the mean 
ggplot(data = ProAdult, aes(x = CountryOfResidence, y = DPmean)) + 
  #geom_bar(stat="identity") + 
  geom_bar(aes(CountryOfResidence, GPmean, fill=Category), stat="identity") +
  coord_flip() + 
